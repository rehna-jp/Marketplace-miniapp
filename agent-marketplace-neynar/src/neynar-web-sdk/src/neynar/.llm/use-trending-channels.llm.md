...
```typescript
import { useTrendingChannels } from "@/neynar-web-sdk/neynar";
```

## Hook Signature

```typescript
function useTrendingChannels(
...
- `time_window?: "1d" | "7d" | "30d"` - Time window for trending calculation (default: '7d')
...
function MyComponent() {
  const result = useTrendingChannels({ time_window: "1d", limit: 123 });
