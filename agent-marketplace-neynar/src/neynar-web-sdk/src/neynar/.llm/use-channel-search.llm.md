...
```typescript
import { useChannelSearch } from "@/neynar-web-sdk/neynar";
```

## Hook Signature

```typescript
function useChannelSearch(
  query: string,
...
- **Type**: `InfiniteQueryHookOptions<ChannelSearchResponse, Channel>`
- **Required**: No
...
function MyComponent() {
  const result = useChannelSearch("example", { limit: 123, viewer_fid: 123 });
