...
```typescript
import { useChannel } from "@/neynar-web-sdk/neynar";
```
...
- **Type**: `string`
- **Required**: Yes
- **Description**: - Channel ID or parent_url for the channel
...
- **Type**: `QueryHookOptions<ChannelResponse, Channel>`
- **Required**: No
...
function MyComponent() {
  const result = useChannel("example", { type: "id", viewer_fid: 123 });
