...
```typescript
import { useParentUrlFeed } from "@/neynar-web-sdk/neynar";
```

## Hook Signature

```typescript
function useParentUrlFeed(
  url: string,
...
- **Type**: `string`
- **Required**: Yes
- **Description**: - The parent URL to retrieve related content for
...
function MyComponent() {
  const result = useParentUrlFeed("example", { cursor: "example", limit: 123 });
