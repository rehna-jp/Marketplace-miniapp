...
```typescript
import { useMultiChannelFeed } from "@/neynar-web-sdk/neynar";
```

## Hook Signature

```typescript
function useMultiChannelFeed(
  channelIds: string[],
...
- **Type**: `string[]`
- **Required**: Yes
- **Description**: - Array of channel identifiers to retrieve content from (max: 10 channels)
...
function MyComponent() {
  const result = useMultiChannelFeed("example", { limit: 123, viewer_fid: 123 });
